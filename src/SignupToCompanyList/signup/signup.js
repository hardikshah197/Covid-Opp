...
class Signup extends Component {
  ...
  handlePhoneChange = (isValid, phone) => {
  ...
  validatePassword = (e) => {
    ...
    const checkSpecialChar = new RegExp("^(?=.*[!@#$%^&*])");
    if (!checkLength.test(password))
      this.setState({
        ...this.state,
        passValidation: "Password should have atleast 8 characters",
      });
    else if (!checkUpperCase.test(password))
      this.setState({
        ...this.state,
        passValidation: "Password should have atleast one upper case character",
      });
    else if (!checkLowerCase.test(password))
      this.setState({
        ...this.state,
        passValidation: "Password should have atleast one lower case character",
      });
    else if (!checkDigit.test(password))
      this.setState({
        ...this.state,
        passValidation: "Password should have atleast one digit",
      });
    else if (!checkSpecialChar.test(password))
      this.setState({
        ...this.state,
        passValidation: "Password should have atleast one special character",
      });
    else {
      this.setState({
        ...this.state,
        passValidation: "Validated",
        password: password,
      });
    }
  };
    ...
    return (
      <div className="signup-body">
        <div className="row">
          <div className="col-md-3">
            ...
            >
              <defs>
                ...
                >
                  <stop offset="0" stopColor="#2feafc" />
                  <stop offset="1" stopColor="#2feafc" stopOpacity="0" />
                </linearGradient>
                <linearGradient
                  ...
                  gradientUnits="objectBoundingBox"
                >
                  <stop offset="0" stopColor="#fe7e1f" />
                  <stop offset="1" stopColor="#ffcf7b" />
                </linearGradient>
                <linearGradient
                  ...
                  gradientUnits="objectBoundingBox"
                >
                  <stop offset="0" stopColor="#fff" stopOpacity="0.478" />
              ...
              >
                ...
                <g id="logo-light" transform="translate(50 38)">
                  <path
                    id="Path_4299"
                    data-name="Path 4299"
                    d="M41.149,0A41.149,41.149,0,1,0,82.3,41.149,41.148,41.148,0,0,0,41.149,0Z"
                    fillRule="evenodd"
                  ...
                  <path
                    id="Path_4300"
                    data-name="Path 4300"
                    d="M54.18,61.869A30.866,30.866,0,1,1,40.874,2.056,41.184,41.184,0,0,1,61.865,37.918,40.96,40.96,0,0,1,54.18,61.869Z"
                    transform="translate(20.434 3.232)"
                    fillRule="evenodd"
          ...
          <div className="col-md-6 col-sm-8 signup-mid signup-form-container form-container">
            <h1 id="welcome">Welcome!</h1>
            <h5 className="subtitle" style={{ maxWidth: "800px" }}>
              Create an account to submit your profile to various companies and
              explore opportunities of your interest
            </h5>
            <form
              className="col align-self-center signup-form"
            ...
            >
              <defs>
                <linearGradient
                  ...
                  gradientUnits="objectBoundingBox"
                >
                  <stop offset="0" stopColor="#535fd7" stopOpacity="0.078" />
                ...
                <linearGradient
                  ...
                  gradientUnits="objectBoundingBox"
                >
                  <stop offset="0" stopColor="#ffbc48" />
                  <stop offset="1" stopColor="#ffbc48" stopOpacity="0.478" />
                </linearGradient>
                <linearGradient
                ...
                >
                  <stop offset="0" stopColor="#fe7e1f" />
                  <stop offset="1" stopColor="#fe7e1f" stopOpacity="0" />
                </linearGradient>
                <linearGradient
                  ...
                  gradientUnits="objectBoundingBox"
                >
                  <stop offset="0" stopColor="#fe7e1f" stopOpacity="0.11" />
                  <stop offset="1" stopColor="#fe7e1f" />
                </linearGradient>
                <linearGradient
                  ...
                  gradientUnits="objectBoundingBox"
                >
                  <stop offset="0" stopColor="#61effd" stopOpacity="0" />
                  <stop offset="0.519" stopColor="#61effd" />
                  <stop offset="1" stopColor="#535fd7" />
                </linearGradient>
                ...
                >
                  <stop offset="0" stopColor="#61effd" stopOpacity="0" />
                  <stop offset="1" stopColor="#61effd" />
                </linearGradient>
                <linearGradient
                ...
                >
                  <stop offset="0" stopColor="#2feafc" />
                  <stop offset="1" stopColor="#fff" stopOpacity="0.478" />
                </linearGradient>
              </defs>
              <g
                id="Group_1948"
                data-name="Group 1948"
                transform="translate(-400 218)"
              >
                <g
                  id="header-illustration-light_1_"
                  data-name="header-illustration-light (1)"
                  transform="translate(459.681 3)"
                >
                  <g
                    id="Group_1710"
                  ...
                  >
                    <path
                      id="Path_4304"
                      data-name="Path 4304"
                      d="M508,528c185.316,72,210-94.02,210-210S623.98,108,508,108,334.965,209,298,318,322.684,456,508,528Z"
                      fillRule="evenodd"
                    ...
                    <circle
                      ...
                      cy="120"
                      r="120"
                      transform="translate(388 198)"
                      fill="url(#linear-gradient-5)"
                    />
                    <path
                      id="Path_4305"
                      data-name="Path 4305"
                      d="M699.233,420c185.316,72,210-94.02,210-210s-94.02-210-210-210-173.035,101-210,210S513.916,348,699.233,420Z"
                      fillRule="evenodd"
                ...
                <g
                  id="hero-media-illustration-light"
                  transform="translate(1188.512 184.487)"
                  opacity="0.74"
                >
                  <path
                    id="Path_4123"
                    data-name="Path 4123"
                    d="M481.636,278.995c68.4-85.6,283.288,114.5,499.6,141.24q216.311,26.745,215.4-52.837l-27.273,441.6Q958.61,610.545,876.515,624.05T761.636,706.995q25.582-286.759-96-201.213C544.054,591.329,413.241,364.592,481.636,278.995Z"
                    transform="translate(42.303 -85.807) rotate(6)"
                    fillRule="evenodd"
                  ...
                  <path
                    id="Path_4124"
                    data-name="Path 4124"
                    d="M163.032,64.417C87.393-12.1,413.123,98.949,629.434,125.693q216.31,26.745,258.39-12.866Q589.687,308.154,504.55,291.06T409.836,412.452q25.582-286.76-96-201.213c-121.582,85.547-75.166-70.31-150.8-146.823Z"
                    transform="translate(8.388 -55.105) rotate(6)"
                    fillRule="evenodd"
                    fill="url(#linear-gradient-8)"
                  />
                  <path
                    id="Path_4125"
                    data-name="Path 4125"
                    d="M48.634,315.836c46.011,63.226,153.516-11.671,369.826,15.073Q634.77,357.654,464.8,283.592,347.68,547.251,293.577,496.277t-80.065,40.59q10.934-205.957-110.65-120.411C-18.718,502,2.624,252.61,48.635,315.836Z"
                    transform="translate(26.392 -28.596) rotate(6)"
                    fillRule="evenodd"
                  ...
                  <path
                    id="Path_4126"
                    data-name="Path 4126"
                    d="M312.97,376.93c68.395-85.6,283.287,114.495,499.6,141.24q216.311,26.743,215.4-52.839l-79.92,257.5q-111.705-121.734-286.07,1.292c-174.365,123.027-22.094-66.692-205.393-43.46S244.575,462.525,312.97,376.93Z"
                    transform="matrix(-0.961, -0.276, 0.276, -0.961, 1109.087, 1278.144)"
                    fillRule="evenodd"
                  ...
                  <path
                    ...
                    transform="translate(26.898 -47.358) rotate(6)"
                    fillRule="evenodd"
                  ...
                  <path
                    id="Path_4128"
                    data-name="Path 4128"
                    d="M113.7,9l1.812.833L116,11.6l-.579,1.68L113.7,14l-1.624-.82L111,11.6l.81-1.837Z"
                    fill="rgba(83,95,215,0.24)"
                    fillRule="evenodd"
                  />
                  <path
                    id="Path_4129"
                    data-name="Path 4129"
                    d="M43.314,43l2.9,1.334L47,47.157l-.926,2.688L43.314,51l-2.6-1.31L39,47.156l1.295-2.94Z"
                    fill="#61effd"
                    fillRule="evenodd"
                  />
                  <path
                    id="Path_4130"
                    data-name="Path 4130"
                    d="M88.314,38l2.9,1.334L92,42.157l-.926,2.688L88.314,46l-2.6-1.31L84,42.156l1.295-2.94Z"
                    fill="#7c85e1"
                    fillRule="evenodd"
                  />
                  <path
                    id="Path_4131"
                    data-name="Path 4131"
                    d="M108.7,72l1.812.833L111,74.6l-.579,1.68L108.7,77l-1.624-.82L106,74.6l.81-1.837Zm-44-12,1.812.833L67,62.6l-.579,1.68L64.7,65l-1.624-.82L62,62.6l.81-1.837Z"
                    fill="#2feafc"
                    fillRule="evenodd"
                  />
                  <path
                    id="Path_4132"
                    data-name="Path 4132"
                    d="M64.7,4l1.812.833L67,6.6l-.579,1.68L64.7,9l-1.624-.82L62,6.6l.81-1.837Z"
                    fill="#93f4fe"
                    fillRule="evenodd"
                  />
                  <path
                    id="Path_4133"
                    data-name="Path 4133"
                    d="M121.7,43l1.812.833L124,45.6l-.579,1.68L121.7,48l-1.624-.82L119,45.6l.81-1.837Z"
                    fill="rgba(97,239,253,0.24)"
                    fillRule="evenodd"
                  />
                  <path
                    id="Path_4134"
                    data-name="Path 4134"
                    d="M171.618,63l1.087.5L173,64.559l-.347,1.008L171.618,66l-.975-.492-.643-.95.486-1.1ZM616.7,604l1.812.833L619,606.6l-.579,1.68L616.7,609l-1.624-.82L614,606.6l.81-1.837Z"
                    fill="#fff"
                    fillRule="evenodd"
                  />
                  <path
                    id="Path_4135"
                    data-name="Path 4135"
                    d="M690.7,546l1.812.833L693,548.6l-.579,1.68L690.7,551l-1.624-.82L688,548.6l.81-1.837Z"
                  ...
                  <path
                    id="Path_4136"
                    data-name="Path 4136"
                    d="M633.7,585l1.812.833L636,587.6l-.579,1.68L633.7,590l-1.624-.82L631,587.6l.81-1.837Z"
                    fill="#fff"
                    fillRule="evenodd"
                  />
                  <path
                    id="Path_4137"
                    data-name="Path 4137"
                    d="M606.314,311l2.9,1.334.787,2.823-.926,2.688L606.314,319l-2.6-1.31L602,315.157l1.295-2.94Z"
                  ...
                  <path
                    id="Path_4138"
                    data-name="Path 4138"
                    d="M639.7,319l1.812.833L642,321.6l-.579,1.68L639.7,324l-1.624-.82L637,321.6l.81-1.837Zm-28,18,1.812.833L614,339.6l-.579,1.68L611.7,342l-1.624-.82L609,339.6l.81-1.837ZM595.618,605l1.087.5.295,1.059-.347,1.008-1.035.433-.975-.492-.643-.95.486-1.1Z"
                    fill="#fff"
                    fillRule="evenodd"
                  />
                  <path
          ...
          >
            <defs>
              ...
              >
                ...
                <stop offset="1" stopColor="#6de1f9" />
              </linearGradient>
              <linearGradient
                id="linear-gradient-2"
                x1="0.964"
                ...
                gradientUnits="objectBoundingBox"
              >
                <stop offset="0" stopColor="#fdc564" />
            ...
            >
              ...
              <path
                id="Path_4642"
                data-name="Path 4642"
                d="M12404.641,5350.8c22.157,40.6,72.109,106.366,72.109,106.366s7.829-4.862,11.522-12.479-.892-17.987,3.25-17.987-.094,18.775,13.318,17.987,5.826-29.23,12.532-17.987-.479,37.253,14.292,62.958,44.795,39.863,44.795,39.863h-188.339V5426.705l51.7,45.7-51.7-83.781v-93.835S12382.483,5310.208,12404.641,5350.8Z"
                transform="translate(-12388.12 28)"
                fill="#afd5ef"
              />
              <path
                id="Path_4643"
                data-name="Path 4643"
                d="M13563.018,6055.655a71.325,71.325,0,0,1,11.024-12.2,100.382,100.382,0,0,1,15.072-10.259,61.679,61.679,0,0,1,8.3-10.663c4.855-4.855,8.663-6.865,11.119-8.758s4.679-4.929,8.169-12.818,4.576-19.125,4.576-19.125.987,2.893-5.394,7.846-13.642,8.254-18.918,12.349c-10.166,7.89-10.284,10.63-13.283,15.276s-1.415,9.861-2.942,12.913-7.065,5.887-11.769,12.259A35.638,35.638,0,0,0,13563.018,6055.655Z"
                transform="translate(-12061 -631)"
                fill="#1592e6"
              />
            </g>
          </svg>
